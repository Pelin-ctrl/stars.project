        ...
        <div className="p-6">
          <div className="flex gap-4 mb-6">
            ...
            <div className="flex items-center gap-2 bg-white border border-gray-300 px-4 py-2 rounded-md">
              ...
              <span className="text-sm text-gray-500">Сент 12/23 - Нояб 12/23</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            <div className="lg:col-span-3 space-y-6">
              <div className="text-center">
                <p className="text-red-400 text-sm mb-4">для понимания текущего положения дел</p>
              </div>
              ...
              <div className="text-center">
                <p className="text-red-400 text-sm mb-4">для прогноза тенденций</p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-gray-300 h-64 rounded-lg p-6">
                  <p className="text-red-400 text-sm mb-4">инвестиционные показатели</p>
                  <div className="flex items-center justify-center h-32">
                    <div className="w-24 h-24 border-4 border-gray-500 rounded-full flex items-center justify-center">
                ...
                <div className="bg-gray-300 h-64 rounded-lg p-6">
                  <p className="text-red-400 text-sm mb-4">федеральные показатели</p>
                  <div className="mt-8">
                    <h3 className="text-lg font-semibold text-gray-600 mb-4">
                      цифры и изменение<br />
                      в процентах
                    </h3>
                    <p className="text-gray-500">(примерно 5)</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-1 space-y-6">
              <div className="text-center">
                <p className="text-red-400 text-sm mb-4">меры гос поддержки</p>
              </div>
              
              <div className="grid grid-cols-1 gap-4">
                <div className="bg-gray-400 p-6 rounded-lg">
                  <div className="text-center">
                    <h3 className="text-sm font-medium text-black mb-2">Название</h3>
                    <div className="text-2xl font-bold text-black mb-2">5 600 600</div>
                    <div className="text-sm text-black">45,5% ↓</div>
                    <div className="text-xs text-gray-600 mt-1">vs прошлый период</div>
                  </div>
                </div>
